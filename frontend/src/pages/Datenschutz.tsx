          ...
          <div className="space-y-6 text-primary-700">
            <section>
              ...
              <p className="mb-4">
                ...
                Benutzerkonto und müssen sich nicht registrieren, um Dokumente zu übersetzen. Wir
                speichern keine personenbezogenen Daten von Endnutzern. Die Verarbeitung Ihrer
                Dokumente erfolgt ohne Zuordnung zu einer persönlichen Identität.
              </p>
              ...
              <p className="mb-4">
                ...
                verarbeitet. Nach Abschluss der Verarbeitung werden alle Daten automatisch gelöscht.
                Es erfolgt keine dauerhafte Speicherung, keine Weitergabe an Dritte und keine
              ...
              <p className="mb-4">
                ...
                <br />
                Da wir keine personenbezogenen Daten von Endnutzern speichern und die Verarbeitung
                vollständig anonym erfolgt, sind die meisten DSGVO-Rechte (wie Auskunft,
                Berichtigung, Löschung) nicht anwendbar. Ihre Dokumente werden automatisch nach der
                Verarbeitung gelöscht, sodass keine Daten mehr vorhanden sind, über die Auskunft
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                nach Abschluss der Verarbeitung (konfigurierbar, kann auf bis zu 0 Stunden reduziert
                werden). Nach Ablauf dieser Frist werden alle Daten automatisch und vollständig
                gelöscht:
              </p>
              ...
              <p className="mb-4">
                ...
                Daten nicht mehr wiederherstellbar. Die automatische Löschung erfolgt durch geplante
                Cleanup-Aufgaben, die stündlich ausgeführt werden.
              </p>
            ...
            <section>
              ...
              <p className="mb-4">
                Die einzige lokale Speicherung, die wir verwenden, ist der Browser-LocalStorage, um
                Ihre Präferenz für das Cookie-Hinweis-Banner zu speichern (ob Sie das Banner
              ...
              <ul className="list-disc list-inside mb-4 ml-4">
                ...
                <li>
                  <strong>Keine Weitergabe:</strong> Keine Weitergabe der Daten an Dritte (außer an
                  den KI-Anbieter OVH für die Übersetzung, wobei nur PII-bereinigte Texte übertragen
                  werden)
                </li>
                <li>
                ...
                <li>
                  <strong>Verschlüsselung bei Speicherung:</strong> Administratorkonten (nicht für
                  Endnutzer) verwenden verschlüsselte Speicherung für E-Mail-Adressen und Namen. Die
                  Verschlüsselung von Dokumentinhalten ist geplant (siehe technische Roadmap).
                </li>
                <li>
                  <strong>Keine Cookies:</strong> Unser Dienst verwendet keine Cookies und speichert
                  keine Tracking-Daten. Dies wird durch ein Cookie-freies Hinweis-Banner auf der
                  Website transparent kommuniziert.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                gelöscht, sodass keine Daten mehr vorhanden sind, über die Auskunft erteilt werden
                könnte.
              </p>
              ...
              <p className="mb-4">
                Da wir keine personenbezogenen Daten von Endnutzern speichern und die Verarbeitung
                anonym erfolgt, können wir keine Auskunft über gespeicherte Daten erteilen, da keine
                solchen Daten existieren. Falls Sie Fragen zum Thema Datenschutz haben, können Sie
                sich jederzeit an uns wenden (siehe Kontakt im Impressum).
              </p>
              ...
              <p className="mb-4">
                ...
                gelöscht. Es ist keine manuelle Löschung erforderlich, da die Löschung automatisch
                erfolgt. Falls Sie eine sofortige Löschung wünschen, können Sie sich an uns wenden.
              </p>
              ...
              <p className="mb-4">
                Da wir keine personenbezogenen Daten von Endnutzern speichern, gibt es keine Daten,
                die übertragen werden könnten. Die Übersetzungsergebnisse können Sie direkt nach der
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                an uns wenden. Die Kontaktdaten finden Sie im{' '}
                <Link
                  to="/impressum"
              ...
              <p className="mb-4">
                ...
                <br />
                Die verantwortliche Stelle für die Datenverarbeitung ist im Impressum dieser Website
                angegeben.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mb-4 ml-4">
                <li>
                  <strong>OVH Cloud (EU):</strong> Für die KI-gestützte Übersetzung. Es werden nur
                  PII-bereinigte Texte an OVH übertragen. Die Datenverarbeitung erfolgt
                  ausschließlich in der EU.
                </li>
                <li>
                  <strong>Railway (EU):</strong> Für das Hosting der Anwendung und der Datenbank.
                  Railway ist SOC 2 Type I zertifiziert und bietet DSGVO-konforme Data Processing
                  Agreements.
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mb-4 ml-4">
                <li>
                  Gesundheitsdaten gehören zu den besonderen Kategorien personenbezogener Daten nach
                  Art. 9 DSGVO
                </li>
                <li>
                  Wir verarbeiten diese Daten ausschließlich zum Zweck der Übersetzung und nur nach
                  Ihrer ausdrücklichen Einwilligung (durch das Akzeptieren der Datenschutzerklärung
                  beim Hochladen)
                </li>
                <li>
                  Die Verarbeitung erfolgt vollständig anonym - es werden keine personenbezogenen
                  Daten von Endnutzern gespeichert
                </li>
                <li>
