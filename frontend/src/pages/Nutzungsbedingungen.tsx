            ...
            <div className="space-y-6 text-primary-700">
              <section>
                ...
                <p className="mb-4">
                  ...
                  einverstanden. Wenn Sie mit diesen Bedingungen nicht einverstanden sind, nutzen Sie 
                  bitte unseren Dienst nicht.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">§ 2 Leistungsbeschreibung</h2>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  (3) Die Übersetzungen ersetzen keine professionelle medizinische Beratung, Diagnose 
                  oder Behandlung.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">§ 3 Nutzungsbedingungen</h2>
                <p className="mb-4">
                  (1) Der Dienst darf nur für persönliche, nicht-kommerzielle Zwecke genutzt werden.
                </p>
                <p className="mb-4">
                  (2) Sie verpflichten sich, den Dienst nur für rechtmäßige Zwecke zu nutzen und keine 
                  Inhalte hochzuladen, die:
                </p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">§ 4 Medizinischer Haftungsausschluss</h2>
                ...
                <p className="mb-4">
                  (3) Bei medizinischen Fragen oder Problemen konsultieren Sie immer einen qualifizierten 
                  Arzt oder Gesundheitsdienstleister.
                </p>
                <p className="mb-4">
                  (4) Im Notfall kontaktieren Sie sofort den Notruf (112) oder suchen Sie die nächste 
                  Notaufnahme auf.
                </p>
                <p className="mb-4">
                  (5) Verlassen Sie sich niemals ausschließlich auf die Übersetzungen dieses Dienstes 
                  für gesundheitsbezogene Entscheidungen.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">§ 5 Haftungsbeschränkung</h2>
                <p className="mb-4">
                  (1) Wir übernehmen keine Haftung für die Richtigkeit, Vollständigkeit oder Aktualität 
                  der Übersetzungen.
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  (3) Dies gilt nicht für Schäden aus der Verletzung des Lebens, des Körpers oder der 
                  Gesundheit sowie für sonstige Schäden, die auf einer vorsätzlichen oder grob 
              ...
              <section>
                ...
                <p className="mb-4">
                  (3) Es erfolgt keine dauerhafte Speicherung oder Weitergabe Ihrer Dokumente an Dritte.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">§ 7 Geistiges Eigentum</h2>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  (2) Die Nutzung des Dienstes gewährt Ihnen keine Rechte an unserem geistigen Eigentum, 
                  außer den in diesen Nutzungsbedingungen ausdrücklich eingeräumten Rechten.
                </p>
              </section>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">§ 9 Änderungen der Nutzungsbedingungen</h2>
                <p className="mb-4">
                  (1) Wir behalten uns vor, diese Nutzungsbedingungen jederzeit zu ändern.
                </p>
                <p className="mb-4">
                  (2) Änderungen werden auf dieser Seite veröffentlicht. Die fortgesetzte Nutzung des 
                  Dienstes nach Veröffentlichung von Änderungen gilt als Zustimmung zu den geänderten 
                  Bedingungen.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">§ 10 Anwendbares Recht und Gerichtsstand</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">§ 11 Salvatorische Klausel</h2>
                <p className="mb-4">
