        ...
        <div className="card-elevated">
          <div className="card-body">
            ...
            <div className="space-y-6 text-primary-700">
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">Angaben gemäß § 5 TMG</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">Berufsbezeichnung und berufsrechtliche Regelungen</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-primary-900 mb-3">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
              ...
              <section>
                ...
                <h3 className="text-lg font-semibold text-primary-800 mt-4 mb-2">Haftung für Inhalte</h3>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-semibold text-primary-800 mt-4 mb-2">Haftung für Links</h3>
                <p className="mb-4">
