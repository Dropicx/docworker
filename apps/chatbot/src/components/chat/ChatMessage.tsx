          ...
          {message.isStreaming && !message.content ? (
            ...
            <>
              <div className="prose prose-sm max-w-none prose-neutral dark:prose-invert
                ...
                prose-ul:my-3 prose-ul:ml-5 prose-ol:my-3 prose-ol:ml-5
                ...
                prose-blockquote:border-l-brand-500 prose-blockquote:bg-brand-50 dark:prose-blockquote:bg-brand-900/20 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:my-4
                prose-hr:my-6
