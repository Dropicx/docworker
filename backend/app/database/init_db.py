...
from app.database.chat_feedback_models import (
    ChatMessageFeedbackDB,  # noqa: F401 - import to register models
)
from app.database.chat_models import (  # noqa: F401 - import to register models
    ChatLogDB,
    ChatRateLimitDB,
)
