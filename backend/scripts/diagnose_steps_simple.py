...
with engine.connect() as conn:
    ...
    print(f'{"Phase":<8} {"ID":<5} {"Name":<45} {"Order":<7} {"DocClassID":<12} {"PostBranch":<12} {"Branching":<10}')
    print('-' * 120)
    ...
    for step in steps:
        ...
        print(f'{phase:<8} {step_id:<5} {name:<45} {order:<7} {doc_class:<12} {str(post_branching):<12} {str(is_branching):<10}')
