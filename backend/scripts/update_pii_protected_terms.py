...
NEW_TERMS = [
    ...
    "OL Karina", "OL-Karina",  # Oberlappen Karina
    ...
    "TI", "MI", "AI", "PI",  # Valve insufficiency abbreviations
    "HFrEF", "HFpEF", "HFmrEF",  # Heart failure types
    "LVEF", "RVEF",  # Ejection fraction
    ...
    "Etrinsa", "Evia", "Edora", "Entovis", "Eluna",
    "DR-T", "SR-T", "HF-T",
    ...
    "IMMUNOASSAY", "Immunoassay", "immunoassay",  # Lab test method - wrongly replaced with [BIC]
    "ANTIGENNACHWEIS", "Antigennachweis",  # Antigen detection
    "MOLEKULARBIOLOGISCHER", "Molekularbiologischer", "molekularbiologischer",
    "DIREKTNACHWEIS", "Direktnachweis",
